...
class Expense(models.Model):
    travel = models.ForeignKey(TravellersGroup, on_delete=models.CASCADE, related_name="expenses")
...
class Settlement(models.Model):
    ...
    travel = models.ForeignKey(TravellersGroup, on_delete=models.CASCADE, related_name="settlements")
    amount = models.DecimalField(max_digits=10, decimal_places=2)
