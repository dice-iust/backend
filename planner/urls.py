...
urlpatterns = [
    ...
    path("travels/<int:travel_id>/expenses/all/", CreateExpenseAPIView.as_view(), name="get-expenses"),
    ...
    path("settle-debt/all/", SettleDebtAPIView.as_view(), name="get-settlements"),
]
